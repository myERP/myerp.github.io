...
|"PUT item_families":item_family/#item_familyies_put|Create and Update several item families in a row.|
...
|"DELETE ../order_lines":accounting_transaction/#accounting_transactions_delete|Delete several accounting transactions in a row. Only manual accounting transactions can be deleted.
In order to delete other transactions, you need to deleted the related document (Invoice, Payment, etc...). |
