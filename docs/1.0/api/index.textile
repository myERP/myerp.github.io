...
p(caption). Chart of Accounts is the list of all accounting accounts. Non family accounts can be use to input "transactions":/docs/1.0/api/transaction/#format.
